package kr.co.evidnet.muse.web.rest;

import kr.co.evidnet.muse.HermesApp;
import kr.co.evidnet.muse.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import kr.co.evidnet.muse.config.audit.AuditEventConverter;
import kr.co.evidnet.muse.domain.PersistentAuditEvent;
import kr.co.evidnet.muse.repository.PersistenceAuditEventRepository;
import kr.co.evidnet.muse.security.AuthoritiesConstants;

import kr.co.evidnet.muse.service.AuditEventService;
...
@SpringBootTest(classes = {HermesApp.class, TestSecurityConfiguration.class})
@Transactional
